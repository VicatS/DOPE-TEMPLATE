                        ...
                        <form action="<?=base_url();?>mantenimiento/accesorios/store" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group fieldGroup"><br>
                                ...
                                <div class="form-group"><br>
                                    ...
                                    <div class="col-xs-3">
                                        ...
                                        <input type="file" name="foto[]" class="form-control" placeholder="Subir Imagen"/>
                                    </div>
                            ...
                            <div class="form-group fieldGroupCopy" style="display: none;">
                                ...
                                <div class="form-group"><br>
                                    ...
                                    <div class="col-xs-4">
                                        <label for="precio">Precio:</label>
                                        <input type="text" name="precio[]" class="form-control" step="0.01" placeholder="Ingrese Precio"/>
                                    </div>
                                    <div class="col-xs-4">
                                        <label for="cantidad">Cantidad:</label>
