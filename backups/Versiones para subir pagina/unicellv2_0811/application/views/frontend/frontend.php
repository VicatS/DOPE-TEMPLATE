		...
		<div class="row">
			...
			<div class="col-sm-6 col-xs-6 text-right">
				<div class="btn-group social-links hidden-sm hidden-xs">	
					<a href="https://www.facebook.com/Uni-Cell-Bolivia-534186803587584/" class="btn btn-link" target="_blank"><i class="icon-facebook4"></i></a>
                ...
                <a href="#" class="signup-button">Registrate</a>
			</div>
		</div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="main-navigation">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="<?php echo base_url();?>frontend" class="active">INICIO</a></li>
                    <!--<li><a href="<?php echo base_url();?>assets/template2/about.html">ABOUT</a></li>-->
                    <li><a href="<?php echo base_url();?>frontend/servicios" >SERVICIOS</a></li>
        ...
        <div class="container">
            ...
            <div class="row zoom-gallery" data-animate="zoomIn" data-delay="0">
                <div class="col-sm-4">
                    ...
                    <a href="<?php echo base_url();?>assets/template2/javascript:;" class="gallery-item-title">ACCESORIOS</a>
                    <p class="gallery-item-descr">Todo tipo de accesorios para tu celular .</p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4" data-animate="fadeInLeft" data-delay="0">
                    ...
                    <p>Contamos con una variedad de accesorios complementarios para tu smartphone
                        de las distintas marcas.</p>
                </div>
                <div class="col-sm-4" data-animate="fadeInLeft" data-delay="300">
                    <h4>TRABAJO GARANTIZADO</h4>
                    <p>Todo trabajo realizado en Uni Cell Bolivia es garantizado y contamos con una 
                ...
                <div class="col-sm-4" data-animate="fadeInLeft" data-delay="600">
                    ...
                    <p>Estamos constantemente en capacitación para ofrecer solución a tus problemas 
