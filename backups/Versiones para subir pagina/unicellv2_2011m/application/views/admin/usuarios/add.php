            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif; ?>
                        <form action="<?=base_url();?>mantenimiento/usuarios/store" method="POST" enctype="multipart/form-data">
                             <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                            ...
                                            <a class="btn btn-primary" href="<?php echo base_url();?>mantenimiento/usuarios"> Cancelar </a>
                                    </div>
                                </div>
                        </form>
                    </div>
