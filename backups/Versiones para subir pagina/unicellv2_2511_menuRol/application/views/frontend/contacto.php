...
<html lang="es" class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Contact | Coco - Responsive Bootstrap Template</title>  
...
<body class=""><div id="wrapper">    <header>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="main-navigation">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="<?php echo base_url();?>frontend" >INICIO</a></li>
                    ...
                    <li><a href="<?php echo base_url();?>frontend/contacto" class="active">CONTACTO</a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
        <!-- /.container-->
    </nav>        <section class="main-slider" data-stellar-background-ratio="0.5" style="background-image: url((assets/template2/images/headers/uni.jpg)">
        <img  src="<?php echo base_url();?>assets/template2/images/headers/contacto.jpg" width="1920" height="550" >
	<div class="slider-caption">

		<h2 data-animate="fadeInDown" data-delay="1000" data-duration="2s">Estamos felices de responder <br>tus preguntas y estar en <br><span class="invert bg-danger">contacto</span> contigo!</h2>
        	</div>
</section>    </header>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <form name="sentMessage" id="contactForm" novalidate>
                        <legend>MANTENGASE EN CONTACTO</legend>
    ...
    <section class="contact-map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d237.19809910140347!2d-67.1122404!3d-17.9708454!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDU4JzE0LjgiUyA2N8KwMDYnNDQuMCJX!5e0!3m2!1ses-419!2sbo!4v1534709524590" width="100%" height="500" frameborder="0" style="border:0" allowfullscreen></iframe>
    </section>
    </div>
    </div>
        <footer>
    ...
    <script src="<?php echo base_url();?>assets/template2/assets/libs/bootstrap-validator/js/bootstrapValidator.min.js"></script>
    <script src="<?php echo base_url();?>assets/template2/http://maps.google.com/maps/api/js?sensor=true"></script>
    <script src="<?php echo base_url();?>assets/template2/assets/libs/jquery-gmap3/gmap3.min.js"></script>
    <script src="<?php echo base_url();?>assets/template2/assets/js/pages/contact.js"></script>
