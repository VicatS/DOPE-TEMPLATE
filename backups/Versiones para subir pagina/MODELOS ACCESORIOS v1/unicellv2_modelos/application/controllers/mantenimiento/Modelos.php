...
class Modelos extends CI_Controller {
	...
	public function storeAccesorios(){
		...
		$color = $this->input->post("coloresaccesorios");
	...
	protected function sumarStock($idmodelo){
		$totalStock = $this->Modelos_model->sumarTotal2($idmodelo);
	}
