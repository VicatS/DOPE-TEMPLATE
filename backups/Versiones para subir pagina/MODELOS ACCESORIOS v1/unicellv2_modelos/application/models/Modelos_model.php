...
class Modelos_model extends CI_Model {
	...
	public function get_modelos(){
		$this->db->select("mo.*,c.nombreCategoria AS categoria, m.nombreMarca AS marca, SUM(ac.stock) AS total");
