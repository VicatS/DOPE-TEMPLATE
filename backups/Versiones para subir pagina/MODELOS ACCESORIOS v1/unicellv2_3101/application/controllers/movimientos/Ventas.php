...
class Ventas extends CI_Controller {
	...
	public function store(){
		...
		if ($this->Ventas_model->save($data)) {
			...
			$this->save_detalle($idAccesorio,$idVenta,$precios,$cantidades,$importes);//datos para detalleVenta
	...
	protected function updateAccesorio($idAccesorio,$cantidad){
		$modeloActual = $this->Modelos_model->get_accesorio($idAccesorio);
		$data = array(
			'stock' => $modeloActual->stock - $cantidad 
		);
		$this->Modelos_model->updateAccesorio($idAccesorio,$data);
	}
