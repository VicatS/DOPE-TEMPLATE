        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
                    <hr class="divider">
                    <form action="<?php echo base_url();?>auth/verificarCodigo" role="form">
                            <input type="text" placeholder="Ingresa tu código" name="codigo" id="subscribe-input" class="form-control input-lg">
                            <button class="btn btn-primary btn-lg subscribe-btn" type="submit">Enviar</button>
                    </form>
                </div>
        </div>
    </section>        <footer>
