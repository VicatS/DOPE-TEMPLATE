...
class Ventas_model extends CI_Model {
	...
	public function get_detalle($id){
		$this->db->select("dv.*,ac.idModelo, CONCAT(ca.nombreCategoria,' ',mo.nombreModelo,' ',co.nombreColor,' ',mo.calidad) as detalleaccesorio",FALSE);
