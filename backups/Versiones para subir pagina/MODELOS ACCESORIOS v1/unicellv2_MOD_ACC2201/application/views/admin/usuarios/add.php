                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?=base_url();?>administrador/usuarios/store" method="POST" enctype="multipart/form-data">
                             <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <div class="col-md-6 <?php echo !empty(form_error("nombreUsuario")==true)? 'has-error':'';?>">
                                    <label for=""> Nombre Usuario</label>
                                        <input type="text" class="form-control"  name="nombreUsuario" value="<?php echo set_value("nombreUsuario"); ?>">
                                        <?php echo form_error("nombreUsuario","<span class='help-block' style='color:red;'>","</span>"); ?>
                                    </div> 
                                    <div class="col-md-6">
