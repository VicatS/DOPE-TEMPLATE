                                ...
                                <?php if(!empty($usuarios)) :?>
                                    <?php foreach ($usuarios as $usuario):?>
                                        <tr>
                                           ...
                                           <td><button type="button" class="btn btn-block btn-<?php if($usuario->status=="1"){echo "success";} else{echo "danger";}?>"><span class="label label-<?php if($usuario->status=="1"){echo "primary";} else{echo "danger";}?>"></span><?php if($usuario->status=="1"){echo "Activo";} else{echo "Inactivo";}?></button></td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                   <button type="button" class="btn btn-info btn-view-usuario" data-toggle="modal" data-target="#modal-default" value="<?php echo $datausuario?>">
                                                    ...
                                                    <a href="<?=base_url();?>administrador/usuarios/delete/<?php echo $usuario->idUsuario;?>" class="btn btn-danger btn-remove-usuario"><span class="fa fa-thumbs-down" title="Dar baja"></span></a>
                                                    <a href="<?=base_url();?>administrador/usuarios/alta/<?php echo $usuario->idUsuario;?>" class="btn btn-success btn-remove-usuario"><span class="fa fa-thumbs-up" title="Dar alta" ></span></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
