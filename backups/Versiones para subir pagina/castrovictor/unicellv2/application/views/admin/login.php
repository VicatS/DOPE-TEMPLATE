...
<html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Login | Coco - Responsive Bootstrap Template</title>  
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-xs-6 text-right">
                ...
                <a href="<?php echo base_url();?>auth" class="login-button">Iniciar Sesión</a><a href="<?php echo base_url();?>assets/template2/signup.html" class="signup-button">Registrate</a>
            </div>
        </div>
        ...
        <!-- /.container-->
    </nav>        <section class="main-slider fullsize" data-stellar-background-ratio="0.5" style="background-image: url(assets/template2/images/headers/uni3t.jpg)">
        ...
        <div class="row">
            ...
            <?php endif; ?>  
                ...
                <div class="form-group">
                    <input type="text" class="form-control input-lg" placeholder="Usuario" required autofocus name="nombre_usuario">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control input-lg" placeholder="Password" required name="contrasena">
                </div>
