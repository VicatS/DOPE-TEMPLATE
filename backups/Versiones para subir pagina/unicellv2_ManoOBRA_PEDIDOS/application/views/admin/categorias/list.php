                                ...
                                <?php if(!empty($categorias)) :?>
                                    <?php foreach ($categorias as $categoria):?>
                                        <tr>
                                            ...
                                            <td><?php echo strtoupper($categoria->nombreCategoria);?></td>
                                            <td><?php echo strtoupper($categoria->descripcion);?></td>
                                            <td>
                                                <div class="btn-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Información de la Categoria <?php echo strtoupper($categoria->nombreCategoria);?></h4>
      </div>
