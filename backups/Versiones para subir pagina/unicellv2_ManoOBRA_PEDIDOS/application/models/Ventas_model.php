...
class Ventas_model extends CI_Model {
	...
	public function transaccion($venta,$detalleventa){
		$this->db->trans_begin();

		$this->db->insert('venta',$venta);
		$detalleventa['idVenta'] = $this->db->insert_id();
		
		$this->db->insert('detalleventa',$detalleventa);
		
		//$this->db->where('idComprobante',$idcomprobante);
		//$this->db->update('comprobante',$comprobante);
		//$this->db->where('idAccesorio',$idAccesorio);
		//$this->db->update('accesorio',$saldos);
