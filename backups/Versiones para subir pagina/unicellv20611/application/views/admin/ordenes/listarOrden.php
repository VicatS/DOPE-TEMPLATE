...
<div class="row">
	<div class="col-xs-6">	
		<b>Cliente:</b> <?php echo $orden->nombrecompleto; ?><br>
		<b>Fecha Recepción:</b> <?php echo $orden->formatted_date; ?><br>
		<b>Equipo recepcionado :</b> <?php echo $orden->modeloEquipo; ?>
	</div>	
	<div class="col-xs-6" align="right">
...
<div class="row">
	<div class="box-body">
		...
		<b>Observaciones :</b> <?php echo $orden->descripcion; ?><br>
